...
const AUTO_YES_PATTERNS = [
  ...
  // 出力停止後(100ms)にのみチェック。Claude出力中は絶対に誤爆しない。
  ...
  // 汎用確認（英語）
  { pattern: /do you want to proceed/i,           response: 'y\r',       safe: true,  delayedOnly: true },
  { pattern: /would you like to continue/i,       response: 'y\r',       safe: true,  delayedOnly: true },
  { pattern: /would you like to install/i,        response: 'y\r',       safe: true,  delayedOnly: true },
  { pattern: /shall i proceed/i,                  response: 'y\r',       safe: true,  delayedOnly: true },
  { pattern: /press enter to continue/i,          response: '\r',        safe: true,  delayedOnly: true },
  { pattern: /press enter\s*$/im,                 response: '\r',        safe: true,  delayedOnly: true },
  { pattern: /proceed\s*\?\s*$/im,                 response: 'y\r',       safe: true,  delayedOnly: true },  // 行末のみ
  { pattern: /continue\s*\?\s*$/im,               response: 'y\r',       safe: true,  delayedOnly: true },  // 行末のみ
  { pattern: /confirm\s*\?\s*$/im,                response: 'y\r',       safe: false, delayedOnly: true },  // 行末のみ
